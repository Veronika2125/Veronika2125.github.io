...
public static Frame forma4 = new Frame();
    ...
    private void doVivod(List<Table> lstTable){
        doClearTable();
    ...
    private void initComponents() {
        ...
        btnExid1.setActionCommand("Назад");
        ...
        jtb2.add(btnExid1);
        btnExid1.getAccessibleContext().setAccessibleName("Назад");
        ...
        dlgZakaz.setPreferredSize(new java.awt.Dimension(800, 350));
    ...
    private void btnAddFormActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddFormActionPerformed
        ...
        Table el;
            ...
            el.setIspol(cmbTarif.getSelectedItem().toString());
            el.setOtvet(cmbTarif.getSelectedItem().toString());
            el.setPrice(Float.parseFloat(txt.getText()));
            doVivod(tableOperation.addNewDogovor(el));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(tbl.getSelectedRowCount()==1){
         tableOperation.DelDogovor(tbl.getSelectedRow());
